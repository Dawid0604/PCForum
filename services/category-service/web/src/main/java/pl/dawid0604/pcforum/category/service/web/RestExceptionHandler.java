...
/**
 * <p>
 *     Class that handles HTTP exceptions and returns elegant and clear
 *     response as {@link ProblemDetail} object.
 * </p>
 *
...
class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    ProblemDetail handleUnauthorized(@NonNull final AuthorizationDeniedException exception) {
        final ProblemDetail problemDetail = buildProblemDetail(
                ...
                "You have not permissions to get this resource.",
                "No Permissions"
        );
    ...
    private static List<Map<String, String>> getValidationViolations(
        ...
        return exception.getConstraintViolations()
                        .stream()
                        .map(v -> Map.of(
                                "field", getFieldName(v.getPropertyPath()),
    ...
    private static String getFieldName(final Path propertyPath) {
        String fieldName = "";
        ...
        return isNotBlank(fieldName) ? fieldName : "unknown";
    }
}
