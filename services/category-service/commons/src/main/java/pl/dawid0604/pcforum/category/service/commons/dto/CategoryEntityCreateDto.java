...
@Schema(
        description = "DTO representing category creation"
)
public record CategoryEntityCreateDto(
        ...
        @Pattern(
                ...
                message = Constants.PARENT_ID_PATTERN_MESSAGE
        )
        @Schema(
                description = Constants.PARENT_ID_SCHEMA_DESCRIPTION,
