...
class SecurityConfig {
    ...
    /**
     * The whitelist endpoints that should be authenticated.
     */
     ...
     *
     * <p>
     *     It permitted all access for {@link #WHITELIST_ENDPOINTS} endpoints.
    ...
    private static void customize(
        ...
        registry.requestMatchers(WHITELIST_ENDPOINTS).permitAll()
                .anyRequest()
                .authenticated();
    }
}
